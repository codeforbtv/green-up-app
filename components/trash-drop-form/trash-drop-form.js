...
export const TrashDropForm = ({
    ...
    const currentTownId =
        userLocation && userLocation.coordinates ? findTownIdByCoordinates(userLocation.coordinates) : "";
        ...
        [
            ...
            () => (
                <View style={{ flex: 1, flexDirection: "row", justifyContent: "space-between" }}>
                    ...
                    >
                        <FontAwesome style={{ color: "#DDD", marginRight: 10 }} size={30} name={"map-signs"} />
                        <View style={{ flex: 1, justifyContent: "center" }}>
        ...
        [
            ...
            () => (
                <View style={{ width: "100%", height: 60 }}>
                    ...
                    >
                        <MaterialCommunityIcons name="earth" size={25} style={{ marginRight: 10 }} color={"#555"} />
    ...
    const btnConfig = [saveBtn];
    if (existingDrop) {
        btnConfig.push(deleteBtn);
    }
                            ...
                            <ScrollView style={{ flexGrow: 1, padding: 20 }}>
                                {R.cond([
                                    [
                                        ...
                                        () => (
                                            <Fragment>
                                                <Text style={styles.label}>{"This drop is for team:"}</Text>
